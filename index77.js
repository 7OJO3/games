...
client.on('messageCreate', async message => {
    ...
    if (message.content === '!روليت') {
        gameParticipants = [];
        isShopOpen = true;
        const embed = new EmbedBuilder().setImage('https://cdn.discordapp.com/attachments/1501300022808023351/1526265026946797718/IMG_9221.png?ex=6a566493&is=6a551313&hm=1d60c1b4ca57681ff27fbe87a39a614a41d1e15dd604c2b16c67d127cd994156&').setDescription(`عدد المشاركين: 0`);
    ...
    if (message.content === '!اسرع') {
        ...
        const embed = new EmbedBuilder().setTitle('أسرع من يكتب الكلمة!').setDescription(`اكتب الكلمة التالية بسرعة: **${randomWord}**`).setImage('https://cdn.discordapp.com/attachments/1501300022808023351/1526265005744328807/IMG_9223.png?ex=6a56648e&is=6a55130e&hm=79b913a89344a3e321c1df13e3b3325f8d4c898daef127f13deecca842cb750d&').setColor(0xFFFDD0);
...
client.on('interactionCreate', async interaction => {
    ...
    if (interaction.customId === 'shop') {
        ...
        const shopEmbed = new EmbedBuilder().setTitle('متجر الأغراض').setDescription('مرحباً بك في المتجر، اختر غرضاً (التكلفة 3 نقاط):').setImage('https://cdn.discordapp.com/attachments/1501300022808023351/1526265045481164850/IMG_9217.png?ex=6a566497&is=6a551317&hm=55830eb570b26ff470b708ba6145526eaf1e2d9dab23d82190bed4461379f1bf&');
        const row = new ActionRowBuilder().addComponents(
